#!/bin/sh -l
#SBATCH --account=e3sm
#SBATCH -o /global/cscratch1/sd/theurich/ESMF-Nightly-Testing/intel_19.1.2_mpi_O_feature_fill_nan/test.bat_%j.o
#SBATCH -e /global/cscratch1/sd/theurich/ESMF-Nightly-Testing/intel_19.1.2_mpi_O_feature_fill_nan/test.bat_%j.e
#SBATCH --time=2:00:00
#SBATCH -C haswell
#SBATCH --qos=regular
#SBATCH --nodes=1
...
module list >& /global/cscratch1/sd/theurich/ESMF-Nightly-Testing/intel_19.1.2_mpi_O_feature_fill_nan/module-test.log
