...
python3 -m pip install . 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_openmpi_g_fix_hconfig/esmpy-install.log
make download 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_openmpi_g_fix_hconfig/esmpy-download.log
deactivate
