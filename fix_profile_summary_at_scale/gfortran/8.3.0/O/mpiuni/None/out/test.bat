...
#SBATCH -o /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_O_fix_profile_summary_at_scale/test.bat_%j.o
#SBATCH -e /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_O_fix_profile_summary_at_scale/test.bat_%j.e
#SBATCH --time=1:00:00
...
module list >& /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_O_fix_profile_summary_at_scale/module-test.log
