...
#SBATCH -o /discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_O_fix_profile_summary_at_scale/build.bat_%j.o
#SBATCH -e /discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_O_fix_profile_summary_at_scale/build.bat_%j.e
#SBATCH --time=2:00:00
...
module list >& /discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_O_fix_profile_summary_at_scale/module-build.log
