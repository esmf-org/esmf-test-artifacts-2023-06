...
#SBATCH -o /work/noaa/da/mpotts/sandbox/pgi_2019_openmpi_g_feature_bopt_g_flags/build.bat_%j.o
#SBATCH -e /work/noaa/da/mpotts/sandbox/pgi_2019_openmpi_g_feature_bopt_g_flags/build.bat_%j.e
#SBATCH --time=2:00:00
...
module list >& /work/noaa/da/mpotts/sandbox/pgi_2019_openmpi_g_feature_bopt_g_flags/module-build.log
