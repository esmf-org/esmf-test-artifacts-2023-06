...
#SBATCH -o /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/nvhpc_23.3_openmpi_O_feature_bopt_g_flags/test.bat_%j.o
#SBATCH -e /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/nvhpc_23.3_openmpi_O_feature_bopt_g_flags/test.bat_%j.e
#SBATCH --time=1:30:00
...
module list >& /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/nvhpc_23.3_openmpi_O_feature_bopt_g_flags/module-test.log
