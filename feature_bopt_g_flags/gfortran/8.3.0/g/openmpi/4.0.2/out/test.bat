...
#SBATCH -o /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_feature_bopt_g_flags/test.bat_%j.o
#SBATCH -e /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_feature_bopt_g_flags/test.bat_%j.e
#SBATCH --time=1:00:00
...
module list >& /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_feature_bopt_g_flags/module-test.log
