...
python3 -m pip install . 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_openmpi_g_feature_bopt_g_flags/esmpy-install.log
make download 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_openmpi_g_feature_bopt_g_flags/esmpy-download.log
deactivate
