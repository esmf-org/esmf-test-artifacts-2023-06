#!/bin/sh -l
#SBATCH --account=e3sm
#SBATCH -o /global/cfs/cdirs/e3sm/theurich/ESMF-Nightly-Testing/aocc_3.2.0_mpiuni_g_feature_hconfig-iter/test.bat_%j.o
#SBATCH -e /global/cfs/cdirs/e3sm/theurich/ESMF-Nightly-Testing/aocc_3.2.0_mpiuni_g_feature_hconfig-iter/test.bat_%j.e
#SBATCH --time=4:00:00
#SBATCH -C cpu
#SBATCH --qos=regular
#SBATCH --nodes=1
...
module list >& /global/cfs/cdirs/e3sm/theurich/ESMF-Nightly-Testing/aocc_3.2.0_mpiuni_g_feature_hconfig-iter/module-test.log
